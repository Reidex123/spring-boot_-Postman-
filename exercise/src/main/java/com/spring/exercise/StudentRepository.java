...
public interface StudentRepository extends JpaRepository<Student, Long> {
    ...
    List<Student> findByYearAndStatus(int year, StudentStatus status);

    // SELECT * FROM students WHERE year >= ?
    List<Student> findByYearGreaterThanEqual(int minYear);  // ← fixed
    ...
    Optional<Student> findByEmailAndYear(String email, int year);
